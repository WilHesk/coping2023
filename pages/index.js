...
export default function Home() {
  return (
    <div>
      ...
      <Hero heading="Stories For a Brighter Future" message="We’re here to build communities & represent you in your best light." button="Coping Festival" button2="Coping Strategy"/>
